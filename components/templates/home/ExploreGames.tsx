...
function productImageRender(index: number) {
  switch (index) {
    ...
    case 1: 
      return (
        <KnowItAll cardOne={gameData[1].cardOne} cardTwo={gameData[1].cardTwo} />
      );
    case 2:
      return (
    ...
    case 3:
      return (
        <CloserToGod cardOne={gameData[3].cardOne} cardTwo={gameData[3].cardTwo} />
      )
    case 4:
      return (
        <Game cardOne={gameData[4].cardOne} cardTwo={gameData[4].cardTwo} cardThree={gameData[4].cardThree} />
      )
    default:
      return (
        <BottomUp cardOne={gameData[0].cardOne} cardTwo={gameData[0].cardTwo} />
    ...
    <Box bg="brand.green600" mt="-1rem" id="explore">
      <Box maxW="1200px" mx="auto" pt="5rem" pb="10rem" px={["1rem", "4rem"]}>
        ...
        >
          ...
          >
            <Flex p="18.5rem">
              {productImageRender(productIndex)}
            </Flex>
